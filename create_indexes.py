...
def generate_post_list_db(post_list: typing.List[int]) -> str:
    ...
    for post_id in post_list:
        ...
        list_file.write(f"| {post_time} | [[{post_fname}\|{post_fname}]] |\n")
    list_file.close()
...
def create_indexes() -> None:
    ...
    for tag in tags_list:
        ...
        tag_safe_name=re.sub(r'[\\/*?:"<>|]',"",tag.strip())
        common_tag_list_file.write(f"| [[{tag_safe_name}\|{tag_safe_name}]] | {len(post_list)} |\n")
        ...
        for post_id in post_list:
            ...
            tag_file.write(f"| {date_formatted} | [[{post_fname}\|{post_fname}]] |\n")
        tag_file.close()
